...
import (
	...
	mysql "github.com/cholazzzb/amaz_corp_be/internal/member/mysql"
)

type Repository interface {
	GetMemberByName(ctx context.Context, memberName string) (Member, error)
...
func (r *MySQLMemberRepository) GetMemberByName(ctx context.Context, memberName string) (mysql.Member, error) {
	result, err := r.mysql.GetMemberByName(ctx, memberName)
	if err != nil {
		return mysql.Member{}, err
	}
	return mysql.Member{
		Name:   result.Name,
...
func (r *MySQLMemberRepository) CreateMember(ctx context.Context, member mysql.Member, userID int64) error {
